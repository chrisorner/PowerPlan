...
layout = html.Div([
    ...
    dbc.Nav(
        ...
        dbc.NavItem(dbc.NavLink('Load Configuration', active=True, href='/profile/', style= {'color': 'white'}, external_link=True)),
        dbc.NavItem(dbc.NavLink('Simulation', href='/simulation/', style= {'color': 'white'}, external_link=True)),
