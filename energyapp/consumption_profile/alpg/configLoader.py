...
folder = 'energyapp/consumption_profile/alpg/output/output/'

cfgOutputDir = 'energyapp/consumption_profile/alpg/output/results'
outputFolder = cfgOutputDir
print(os.getcwd())
cfgFile = 'energyapp/consumption_profile/alpg/configs/external_inputs.py'
