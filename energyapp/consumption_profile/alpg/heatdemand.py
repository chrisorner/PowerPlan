        ...
        for p in range(0, len(persons)):
            ...
            if showerDuration > 0:  # actually use the shower
                ...
                for i in range(0, 1440 - (showerDuration + 5)):
                    option = True
                    if showerOccupancy[i] == 0 and occupancyPerson[p][i] > 0 and occupancyPerson[p][
                        i + showerDuration + 5] > 0 and showerOccupancy[i + showerDuration + 5] == 0:
                        # Check for sure:
...
class Thermostat(HeatDevice):
    ...
    def writeDevice(self, hnum):
        writer.writeDeviceThermostat(self, hnum)
