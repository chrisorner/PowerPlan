...
folder = 'energyapp/dashapp_profile/alpg/output/output/'

cfgOutputDir = 'energyapp/dashapp_profile/alpg/output/results'
outputFolder = cfgOutputDir
print(os.getcwd())
cfgFile = 'energyapp/dashapp_profile/alpg/configs/external_inputs.py'
