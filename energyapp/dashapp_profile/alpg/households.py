...
from energyapp.dashapp_profile.alpg import persons
from energyapp.dashapp_profile.alpg import devices
from energyapp.dashapp_profile.alpg import heatdemand
...
class Household:
    ...
    def simulate(self):
        ...
        if self.House.hasPV:
            ...
            self.PVProfile = self.Devices['PVPanel'].simulate(external_inputs.startDay, external_inputs.numDays * ((3600 * 24) / 60),
