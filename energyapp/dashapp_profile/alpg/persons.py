...
class Person:
    ...
    def generate(self, age):
        ...
        self.WorkdayActivities = random.randint(external_inputs.personWeekdayActivityChanceMin,
                                                external_inputs.personWeekdayActivityChanceMax) / 100  # Chance to conduct random activities
        ...
        self.WeekendActivities = random.randint(external_inputs.personWeekendActivityChanceMin,
