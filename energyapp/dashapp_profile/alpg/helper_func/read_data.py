...
def read_alpg_data(start, end):
    ...
    #E_cons['Lighting']=pd.read_csv("energyapp/dashapp_profile/alpg/output/results/Electricity_Profile_GroupLighting.csv")
    #E_cons['Other']=pd.read_csv("energyapp/dashapp_profile/alpg/output/results/Electricity_Profile_GroupOther.csv")
    #E_cons['Standby']=pd.read_csv("energyapp/dashapp_profile/alpg/output/results/Electricity_Profile_GroupStandby.csv")
    #E_cons['HeatDemand'] = pd.read_csv("energyapp/dashapp_profile/alpg/output/results/Heatdemand_Profile.csv")
