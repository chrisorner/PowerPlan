...
from energyapp.blueprints.user.decorators import role_required
from energyapp.blueprints.admin.models import Dashboard
from energyapp.blueprints.user.models import User
from energyapp.blueprints.admin.forms import (
    SearchForm,
    BulkDeleteForm,
    UserForm
)
...
def users(page):
    ...
    paginated_users = User.query \
        ...
        #.filter(text(User.search(request.args.get('q', ''))))) \
